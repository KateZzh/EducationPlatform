import { getAllUsersDB, getUserByIdDB, updateUserDB, deleteUserDB, createUserTestDB } from '../repository/user.repository';
...
async function createUserTest(name: string, surname: string, email: string, pwd: string) {
